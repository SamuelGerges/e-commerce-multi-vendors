                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <ul>
                                                                                @foreach($child -> children  as $subChild)
                                                                                    <li class="item ">
                                                                                        <a href="{{route('category',$subChild -> slug )}}"
                            ...
                            <div id="megamenu" class="nov-megamenu clearfix">
                                <ul class="menu level1">
                                    <li class="item home-page has-sub"><span class="opener"></span><a
                                            href="" title="Home"><i class="zmdi zmdi-home"></i>Home</a>
                                        <div class="dropdown-menu" style="width:200px">
                                            <ul class="">
                                                <li class="item "><a href="" title="Homepage 1">Homepage
                                                        1</a></li>
                                                <li class="item "><a href="" title="Homepage 2">Homepage
                                                        2</a></li>
                                                <li class="item "><a href="" title="Homepage 3">Homepage
                                                        3</a></li>
                                                <li class="item "><a href="" title="Homepage 4">Homepage
                                                        4</a></li>
                                                <li class="item "><a href="" title="Homepage 5">Homepage
                                                        5</a></li>
                                                <li class="item "><a href="" title="Homepage 6">Homepage
                                                        6</a></li>
                                                <li class="item "><a href="" title="Homepage 7">Homepage
                                                        7</a></li>
                                                <li class="item "><a href="" title="Homepage 8">Homepage
                                                        8</a></li>
                                            </ul>
                                        </div>
                                    </li>
                                                                ...
                                                                <div class="menu-content">
                                                                    <div class="menu-banner-3 text-center"><a
                                                                            href="#"><img class="img-fluid"
                                                                                          src="{{asset('assets/front/img/mega-menu-3.jpg')}}"
                                                                    ...
                                                                    <div class="row">
                                                                        <div
                                                                            ...
                                                                            <a href="#"><img class="img-fluid"
                                                                                             src="{{asset('assets/front/img/banner-mega-1.jpg')}}"
                                                                                             alt="menu-banner-1"></a>
                                                                        </div>
                                                                        <div
                                                                            class="col-4 col-lg-4 col-md-4 mt-xs-10 text-center">
                                                                            <a href="#"><img class="img-fluid"
                                                                                             src="{{asset('assets/front/img/banner-mega-2.jpg')}}"
                                                                                             alt="menu-banner-2"></a>
                                                                        </div>
                                                                        <div
                                                                            class="col-4 col-lg-4 col-md-4 mt-xs-10 text-center">
                                                                            <a href="#"><img class="img-fluid"
                                                                                             src="{{asset('assets/front/img/banner-mega-3.jpg')}}"
                                                                                             alt="menu-banner-3"></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
