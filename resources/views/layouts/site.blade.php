...
<head>
    ...
    <style>
        ...
        #popup-subscribe .modal-dialog .modal-content {
            background-image: url({{asset('assets/front/modules/novthemeconfig/images/newsletter_bg-1.png')}});
        }
    </style>
            ...
            <div class="w-100">
                <div class="item-currency current">
                    <a title="British Pound" rel="nofollow"
                       href="">British Pound: GBP</a>
                </div>
                <div class="item-currency">
                    <a title="US Dollar" rel="nofollow"
                       href="">US Dollar: USD</a>
                </div>
            </div>
        </div>
        ...
        <div id="box-language" class="box-content d-flex">
            <div class="w-100">
                <div class="item-language current">
                    <a href="" class="d-flex align-items-center"><img class="img-fluid mr-2"
