                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title"
                                        id="basic-layout-form"> {{ __('admin/tags/tag.add_new_tag') }} </h4>
                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="la la-check-square-o"></i> {{ __('admin/tags/tag.save') }}
                                                </button>
                                            </div>
                                        </form>
                                    </div>
