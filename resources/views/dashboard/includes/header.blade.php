            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <h3 class="brand-text">{{__('admin/includes/header.site_name')}}</h3>
                    </a>
                </li>
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span class="mr-1">{{__('admin/includes/header.hello')}}
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="{{ route('admin.edit.profile') }}">
                                <i class="ft-user"></i>{{__('admin/includes/header.edit_profile')}}
                            </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{ route('admin.edit.profile.password') }}">
                                <i class="ft-user"></i>{{__('admin/includes/header.edit_profile_password')}}
                            </a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{ route('admin.logout') }}">
                                <i class="ft-power"></i> {{__('admin/includes/header.logout')}}
                            </a>
                        </div>
                    </li>
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h6 class="dropdown-header m-0">
                                    <span class="grey darken-2">{{__('admin/includes/header.notifications')}}</span>
                                </h6>
                                <span
