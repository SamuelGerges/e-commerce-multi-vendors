        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    ...
                    <li>
                        <a class="menu-item" href="" data-i18n="nav.dash.crypto">أضافة قسم جديد </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                ...
                <ul class="menu-content">
                    ...
                    <li>
                        <a class="menu-item" href="" data-i18n="nav.dash.crypto">أضافة متجر </a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" nav-item">
                <a href="#"><i class="la la-television">
                    </i><span class="menu-title" data-i18n="nav.templates.main">{{__('admin/includes/sidebar.settings')}}</span>
                </a>
                <ul class="menu-content">
                    <li>
                        <a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{__('admin/includes/sidebar.shipping_method')}}</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{ route('admin.edit.shipping.method','free') }}"
                                   data-i18n="nav.templates.vert.classic_menu">{{__('admin/includes/sidebar.free_shipping')}}</a>
                            </li>
                            <li>
                                <a class="menu-item" href="{{ route('admin.edit.shipping.method','inner') }}">{{__('admin/includes/sidebar.local_shipping')}}</a>
                            </li>
                            <li>
                                <a class="menu-item" href="{{ route('admin.edit.shipping.method','outer') }}"
                                   data-i18n="nav.templates.vert.compact_menu">{{__('admin/includes/sidebar.outer_shipping')}}</a>
                            </li>
                        </ul>
                    </li>
                </ul>
